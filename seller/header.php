            ...
            <ul class="nav nav-secondary">
                  ...
                  <ul class="nav nav-collapse">
                    <li>
                      <a href="booking-history.php">
                        <span class="sub-item">Appointments & Bookings</span>
                      </a>
                    <li>

                        <li>
                      <a href="upcoming-sessions.php">
              ...
              <li class="nav-item">
                ...
                <div class="collapse" id="chats">
                  <ul class="nav nav-collapse">
                    <li>
                      <a href="chat-list.php">
                        <span class="sub-item">Chat List</span>
                      </a>
                    <li>
                  </ul>
                </div>
                 ...
                 <li class="nav-item">
                <a data-bs-toggle="collapse" href="#mas">
                  <i class="fas fa-wallet"></i>
                  <p>Wallet & Earnings</p>
                  <span class="caret"></span>
                </a>
                <div class="collapse" id="mas">
                  <ul class="nav nav-collapse">
                    <li>
              ...
              <li class="nav-item">
                <a data-bs-toggle="collapse" href="#promote">
                  <i class="far fa-flag"></i>
                  <p>Services Promotion</p>
                  <span class="caret"></span>
                </a>
                <div class="collapse" id="promote">
                  <ul class="nav nav-collapse">
                    <li>
                      <a href="boost-listing.php">
                        <span class="sub-item">Boost listing </span>
                      </a>
                    </li>

                     <li>
                      <a href="request-features.php">
                        <span class="sub-item">Request homepage feature </span>
                      </a>
                    </li>

                      <li>
                        <a href="share-profile.php">
                          <span class="sub-item">Share profile </span>
                        </a>
                      </li>
                  </ul>
                </div>
               ...
               <li class="nav-item">
                ...
                <div class="collapse" id="documents">
                  <ul class="nav nav-collapse">
                    <li>
                      <a href="upload-verify.php">
                        <span class="sub-item">Upload & Verification</span>
                      </a>
                    </li>
                  </ul>
                </div>
                  ...
                  <ul class="nav nav-collapse">
                    <li>
                      <a href="edit-contact.php">
                        <span class="sub-item">Edit contact info</span>
                      </a>
                    </li>
                  ...
                  <ul class="dropdown-menu dropdown-user animated fadeIn">
                    <div class="dropdown-user-scroll scrollbar-outer">
                      ...
                      <li>
                        ...
                        <a class="dropdown-item" href="edit-contact.php">My Profile</a>
                        <a class="dropdown-item" href="payment-history.php">My Balance</a>
                        <a class="dropdown-item" href="chat-list.php">Inbox</a>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="edit-contact.php">Account Setting</a>
                        <div class="dropdown-divider"></div>
