            ...
            <form class="enrollment-form" action="process_enrollment.php" method="POST" enctype="multipart/form-data">
              ...
              <div class="row mb-3">
                ...
                <div class="col-md-6">
                  ...
                  <input type="text" name="registered_business" class="form-control">
                </div>
              </div>
              <div class="row mb-3">
                <div class="col-md-6">
              ...
              <h4 class="mt-5 mb-2">Section 2: Professional Qualifications</h4>
              ...
              <div class="form-check mb-2">
                <input class="form-check-input" type="checkbox" name="agreement[]" value="commission" required>
                <label class="form-check-label">I agree that MARRIAGE.NG will charge a 20% commission on every successful sale of my course or program.</label>
              </div>
              <div class="form-check mb-2">
                <input class="form-check-input" type="checkbox" name="agreement[]" value="ethics" required>
                <label class="form-check-label">I agree to uphold professional conduct, protect client confidentiality, and maintain ethical standards in all training activities.</label>
              </div>
