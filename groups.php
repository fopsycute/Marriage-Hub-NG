  ...
  <main class="main">
    ...
    <div class="page-title light-background">
      <div class="container d-lg-flex justify-content-between align-items-center">
        <h1 class="mb-2 mb-lg-0">Tribes & Groups</h1>
        <nav class="breadcrumbs">
          <ol>
            <li><a href="index.html">Home</a></li>
            <li class="current">Tribes & Groups</li>
          </ol>
        </nav>
      </div>
    </div><!-- End Page Title -->
        ...
        <div class="row">
          <div class="col-lg-3">
            <div class="course-filters" data-aos="fade-right" data-aos-delay="100">
              <h4 class="filter-title">Filter Tribes & Groups</h4>
          ...
          <div class="col-lg-9">
            <div class="courses-header" data-aos="fade-left" data-aos-delay="100">
              <div class="search-box">
                ...
                <input type="text" placeholder="Search Tribes & Groups...">
              </div>
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="course-content">
                      ...
                      <div class="instructor-info">
                        ...
                        <span class="instructor-name">Group Creator</span>
                      </div>
                      <a href="enroll.html" class="btn-course">View</a>
                    </div>
                  </div><!-- End Course Card --><!-- End Course Card -->
                </div>
